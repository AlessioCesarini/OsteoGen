...
def train_model():
    ...
    dataset = OsteoDataset() #Carichi il Dataset. La classe OsteoDataset è definita in dataset.py e si occupa di leggere le immagini dalla cartella data/processed, applicare eventuali trasformazioni e restituire coppie di immagini (input, target).
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, (ossa, animali_veri) in enumerate(dataloader):
